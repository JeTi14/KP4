...
\begin{align*}
	&\text{Wähle: } m_n= 4\text{ mm, } d_2 = d_3 = 300 \text{ mm} \\
	&m_t =  \frac{m_n}{\cos(\beta)} = 4,26 \text{ mm} \\
	&d_1 = \frac{d_3}{i_{1,3}} = 100 \text{ mm} \\
	&z_1 = \frac{100 \text{ mm} \x \cos(20^\circ)}{4 \text{ mm}} \text{ mm} = 23,5 \implies z_1 = 24\\
	&z_2=z_3 = z_1 \x i_{1,3} =24 \x 3 = 72 \\
	&d_{1,neu} = \frac{24 \x 4 \text{ mm}}{\cos(20^\circ)} = 102,16 \text{ mm} \\
	&d_{2,neu} = d_{3,neu} = \frac{72 \x 4 \text{ mm}}{\cos(20^\circ)} = 306,5 \text{ mm} \\
	&d_{1,a} = 4\text{ mm} \x \left(\frac{24}{\cos(20^\circ)}+2\right) =110,16\text{ mm} \\
	&d_{1,f} = 102,16\text{ mm} -2,5 \x 4\text{ mm} =92,16\text{ mm} \\
	&d_{2,a} = d_{3,a} =4\text{ mm} \x \left(\frac{72}{\cos(20^\circ)}+2\right) =314,48\text{ mm} \\
	&d_{2,f} =d_{3,f} = 306,5\text{ mm} -2,5 \x 4\text{ mm} =296,5\text{ mm} \\
\end{align*}
